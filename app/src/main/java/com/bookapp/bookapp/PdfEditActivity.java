...
import com.bookapp.bookapp.databinding.ActivityPdfEditBinding;
...
public class PdfEditActivity extends AppCompatActivity {
    ...
    private void updatePdf() {
        ...
        //show progress
        progressDialog.setMessage("Updating File info...");
        progressDialog.show();
        ...
        ref.child(bookId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Log.d(TAG, "onSuccess: File update...");
                        progressDialog.dismiss();
                        Toast.makeText(PdfEditActivity.this, "File info update...", Toast.LENGTH_SHORT).show();
