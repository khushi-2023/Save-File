...
public class MyApplication extends Application {
    ...
    //created a static method to convert timestamp to proper date format, so we can use it everywhere in project, no need to rwirte angain
    ...
    public static void loadCategory(String categoryId, TextView categoryTv) {
        //get categoryId using categoryId
