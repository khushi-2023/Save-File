...
public class pincode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(pincode.this,More.class));
            }
        });
        ...
        mRequestQueue = Volley.newRequestQueue(pincode.this);
        ...
        getDataBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(pinCode)) {
                    ...
                    // text field is empty
                    Toast.makeText(pincode.this, "Please enter valid pin code", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void getDataFromPinCode(String pinCode) {
        ...
        RequestQueue queue = Volley.newRequestQueue(pincode.this);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new com.android.volley.Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(pincode.this, "Pin code is not valid.", Toast.LENGTH_SHORT).show();
                pinCodeDetailsTV.setText("Pin code is not valid");
            }
        });
